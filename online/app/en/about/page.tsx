...
export default function AboutPageEN() {
  return (
    <main style={{
      ...
      <h1 style={{ fontSize: '2rem', marginBottom: '0.5rem', marginTop: '1.5rem' }}>About Hexlide</h1>
      <p style={{ fontSize: '1.05rem', color: '#1e293b' }}>
        Hexlide is a tactical 2-player hex strategy game. You can move the board tiles themselves,
