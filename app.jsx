        ...
        const t = (key) => STRINGS[key] || I18N.ja[key] || key;
        ...
        const ShuffleAnimation = ({ strings }) => {
            return (
        ...
        const NonagaGame = () => {
            ...
            const resetGame = () => {
                ...
                // AI対戦モードの場合、先攻後攻をランダムに再設定 + シャッフルアニメーション
                if (gameMode === 'ai') {
                    setIsShuffling(true);
                    ...
                    if (phase === 'move_token') {
                        ...
                        emptyTiles.forEach(({ tile: selectedTile, index: selectedIndex }) => {
                            ...
                            candidates.forEach((dest, k) => {
                                ...
                                // 相手が次のターンで勝てるなら、このタイル移動で阻止できる場合は超高得点
                                ...
                                if (enemyCanWinNextTurn && isEnemyPieceOnSelectedTile) {
                                    // 相手のコマが乗っているタイルを動かすことで勝利を阻止
                                    score += 15000; // 最優先
                                } else if (enemyCanWinNextTurn) {
                                    // 相手が勝てる状況だが、このタイル移動では阻止できない
                                    score -= 5000; // ペナルティ
                                }
